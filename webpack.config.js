    ...
    var config = {
        ...
        module: {
            ...
            loaders: [
                ...
                {test: /\.(svg|woff|woff2|ttf|eot)$/, loader: 'file?name=/fonts/[path][name].[ext]?[hash]&context=./themes/waschnick/src/fonts/'},
                {test: /\.(gif|png)$/, loader: 'file?name=/images/[path][name].[ext]?[hash]&context=./node_modules/'},
